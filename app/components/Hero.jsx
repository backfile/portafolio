    ...
    return(
      <section id="inicio" className='flex flex-col justify-center min-h-screen mb-10'>
        <div className='flex-col flex'>
          <h1 className='text-6xl font-bold text-[#FDF0D5] mb-7 max-[600px]:text-4xl max-[600px]:text-center max-[600px]:mb-28'><span className='text-[16px] text-[#FCDA95] max-[600px]:text-2xl max-[600px]:font-bold'>Hola, mi nombre es</span><br/>Franco Caraffa.</h1>
          <TypingTitle/>
