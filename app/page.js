...
export default function Home() {
  ...
  <>
    <header className='shadow-md'>
      <ul className='flex justify-center gap-10 p-10 text-[#FDF0D5]'>
        <li>Inicio</li>
        <li>Sobre Mi</li>
        <li>Contacto</li>
      </ul>
    ...
    <main>
      <section className='mt-20 flex justify-center'>
        <div className='flex-col flex'>
          <h1 className='text-3xl font-bold text-[#FDF0D5] mb-10'><span className='text-2xl'>¡Hola!</span><br/>Soy Franco Caraffa</h1>
          <h2 className='font-black text-5xl text-[#669BBC] underline'>Frontend developer</h2>
          <div className='flex gap-5 mt-4'>
            <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="none" viewBox="0 0 76 76">
            ...
            <button className='bg-[#FDF0D5] p-2 rounded-lg w-32'>Descargar CV</button>
          </div>
        </div>
        <Image className='rounded-[50%] ml-5' src={foto} width={230} height={50}/>
      </section>
      <div className='bg-[#1D1C1C] mt-20 h-[1000px]'>
        <section>
          <h2>Acerca de mí</h2>
          <p>ASD</p>
        </section>
